                                ...
                                <div class="row banner_section">
                                    ...
                                    <div class="container-image-text">
                                        <div class="container-image">
                                            ...
                                            <img src="{{url('public/asset/images/bannerimage.png')}}" class="logo-banner-image">
                                        </div>
                                        <div class="container-text">
                                           ...
                                           <div class="container-profile">
                                            <img src="{{url('public/asset/images/profilethumb.png')}}"class="logo-banner-image2">
                                            <img src="{{url('public/asset/images/uploadicon.png')}}"class="logo-banner-image3">
                                           </div>
