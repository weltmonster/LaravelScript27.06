                    ...
                    <tbody class=" tab text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="kt-label-font-color-2 kt-font-bold open-tag">{{ __('backend/management.tickets.status_data.open') }}</span>
                                @endif
                            </td>
                            <td>
                            ...
                            <td class="lst-icon">
                                <a href="{{ route('backend-management-ticket-edit', $ticket->id) }}"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M18.5 2.50023C18.8978 2.1024 19.4374 1.87891 20 1.87891C20.5626 1.87891 21.1022 2.1024 21.5 2.50023C21.8978 2.89805 22.1213 3.43762 22.1213 4.00023C22.1213 4.56284 21.8978 5.1024 21.5 5.50023L12 15.0002L8 16.0002L9 12.0002L18.5 2.50023Z" stroke="#BBBBBB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <a href="{{ route('backend-management-ticket-delete', $ticket->id) }}"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
