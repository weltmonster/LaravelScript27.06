                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users"
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="eddlt-icon">
                                <a href="{{ route('backend-management-ticket-category-edit', $ticketCategory->id) }}"><svg
                                ...
                                <a href="{{ route('backend-management-ticket-category-delete', $ticketCategory->id) }}"><svg
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="card-body py-4 table-footer">
            ...
            <div class="page-no"><span class="page-number">
                    < </span> <span class="page-number active"> 1 </span> <span class="page-number"> 2 </span> <span
                            class="page-number"> 3 </span> <span class="page-number"> . </span> <span
                            class="page-number"> . </span> <span class="page-number"> . </span> <span
