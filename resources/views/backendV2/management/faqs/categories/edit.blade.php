                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__head mt-5">
                                    <div class="kt-portlet__head-label">
                                        <h2 class="kt-portlet__head-title edit-category">{{ __('backend/management.faqs.categories.edit.title') }}</h2>
                                    </div>
                                </div>
                                <form method="post" class="kt-form"
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit"
                                                    class="btn btn-primary edit-submit">{{ __('backend/management.faqs.categories.edit.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
