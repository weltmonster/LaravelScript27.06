                            ...
                            <div class="d-flex align-items-center position-relative my-1 Search-btn">
                                ...
                                <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <rect opacity="1" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1"
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14 bg-dark"
                        ...
                        <table class="table align-middle fs-6 gy-5" id="kt_table_users"
                            ...
                            <thead style=" width: 100%">
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0" style=" width: 100%">
                                    ...
                                    <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                                        rowspan="1" colspan="1">Stock Status</th>
                                    <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                                        rowspan="1" colspan="1">Sales</th>
                                    <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                            ...
                            <tbody class="text-gray-600 fw-semibold" style="width: 100%">
                                <tr style="width: 100%">
                                    ...
                                    <td>
                                        <div class="badge-invalid"><span>Sold out</span></div>
                                    </td>
                                ...
                                <tr style="width: 100%">
                                    ...
                                    <td>
                                        <div class="badge-paid"><span>02</span></div>
                                    </td>
                                    <td class="text-start">1</td>
                                    <td class="lst-icon">
                                        <a href="#"><svg
                                ...
                                <tr style="width: 100%">
                                    ...
                                    <td>
                                        <div class="badge-pending"><span>Unlimited</span></div>
                                    </td>
                                    <td class="text-start">1</td>
                                    <td class="lst-icon">
                                        <a href="#"><svg
