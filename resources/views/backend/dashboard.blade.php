                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\UserTicket::where('status', 'open')->count() }}</div>
                ...
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\User::where('newsletter_enabled', 1)->count() }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
                ...
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\Setting::get('shop.total_sells', 0) }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-4 order-lg-2 order-xl-1">
                        ...
                        <div class="k-widget-12__body">
                            <div class="k-widget-12__head">
                                <div class="k-widget-12__date k-widget-12__date--warning">
                                    ...
                                    <span
                                        class="k-widget-12__month">{{ __('backend/dashboard.months_number.' . date('m', time())) }}</span>
                                </div>
                ...
                <div class="k-portlet k-portlet--height-fluid-half k-widget-13">
                    <div class="k-portlet__body">
                        <div id="k-widget-slider-13-2" class="k-slider carousel slide" data-ride="carousel"
                             data-interval="4000">
                            <div class="k-slider__head">
                                ...
                                <div class="k-slider__nav">
                                    <a class="k-slider__nav-prev carousel-control-prev" href="#k-widget-slider-13-2"
                                       role="button" data-slide="prev">
                                        <i class="fa fa-angle-left"></i>
                                    </a>
                                    <a class="k-slider__nav-next carousel-control-next" href="#k-widget-slider-13-2"
                                    ...
                                    <div class="carousel-item @if($loop->iteration == 1) active @endif k-slider__body">
                                        <div class="k-widget-13">
                                            <div class="k-widget-13__body">
                                                <a class="k-widget-13__title"
                                                   href="{{ route('product-page', $bestsellerProduct->id) }}"
                                                   target="_product">
                                            <span class="kt-widget-15__foot-label btn btn-sm btn-label-brand btn-bold"
            ...
            var recentTicketsInit = function () {
                ...
                var datatable = $('#k_recent_tickets').KDatatable({
                    ...
                    columns: [{
                        ...
                        template: function (response) {
                            return '\
								<a href="' + response['url'] + '" class="btn btn-clean  btn-sm btn-icon-md">\<i class="la la-edit"></i> {{ __("backend/dashboard.recent_tickets.edit") }}\</a>\
							';
                        }
                    }]
                });
