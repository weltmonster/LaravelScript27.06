                        ...
                        <div class="k-portlet__body">
                            ...
                            <form method="POST" action="{{ route('backend-bitcoin-primarywallet-form') }}">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    <label
                                        for="bitcoin_primarywallet_address">{{ __('backend/bitcoin.primarywallet.walletaddress') }}</label>
                                    <input type="text"
                                           class="form-control @if($errors->has('bitcoin_primarywallet_address')) is-invalid @endif"
                                           name="bitcoin_primarywallet_address" id="bitcoin_primarywallet_address"
                                           placeholder="{{ __('backend/bitcoin.primarywallet.walletaddress') }}"
                                           value="{{ strlen(App\Models\Setting::get('bitcoin.primarywallet')) > 0 ? decrypt(App\Models\Setting::get('bitcoin.primarywallet')) : '' }}"/>
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-wide btn-bold btn-danger"
                                           value="{{ __('backend/bitcoin.primarywallet.submit_button') }}"/>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="k-portlet__body">
                            <div class="form-group" style="width: 100%;">
                                <input type="text" onClick="$(this).select()" class="form-control text-center"
                                       value="{{ App\Classes\BitcoinAPI::getBitcoinClient()->getnewaddress(Auth::user()->username, 'p2sh-segwit') }}"
                                       readonly/>
                            </div>

                            <div class="form-group">
                                <a href="{{ route('backend-bitcoin-dashboard') }}"
                                   class="btn btn-wide btn-bold btn-danger">{{ __('backend/bitcoin.generateaddress.regenerate') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="k-portlet">
                        ...
                        <div class="k-portlet__body">
                            <form method="POST" action="{{ route('backend-bitcoin-sendbtc-form') }}">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    <label
                                        for="bitcoin_sendbtc_address">{{ __('backend/bitcoin.sendbtc.walletaddress') }}</label>
                                    <input type="text"
                                           class="form-control @if($errors->has('bitcoin_sendbtc_address')) is-invalid @endif"
                                           name="bitcoin_sendbtc_address" id="bitcoin_sendbtc_address"
                                           placeholder="{{ __('backend/bitcoin.sendbtc.walletaddress') }}"
                                           value="{{ old('bitcoin_sendbtc_address') }}"/>
                                ...
                                <div class="form-group" style="width: 100%;">
                                    <label
                                        for="bitcoin_sendbtc_amount">{{ __('backend/bitcoin.sendbtc.amount') }}</label>
                                    <input type="text"
                                           class="form-control @if($errors->has('bitcoin_sendbtc_amount')) is-invalid @endif"
                                           name="bitcoin_sendbtc_amount" id="bitcoin_sendbtc_amount"
                                           placeholder="{{ __('backend/bitcoin.sendbtc.amount') }}"
                                           value="{{ old('bitcoin_sendbtc_amount') }}"/>
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input type="text"
                                           class="form-control @if($errors->has('bitcoin_sendbtc_fee')) is-invalid @endif"
                                           name="bitcoin_sendbtc_fee" id="bitcoin_sendbtc_fee"
                                           placeholder="{{ __('backend/bitcoin.sendbtc.fee') }}"
                                           value="{{ App\Classes\BitcoinAPI::getRecommendedFee()['btc'] }}"/>
                                    <small>
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-wide btn-bold btn-danger"
                                           value="{{ __('backend/bitcoin.sendbtc.submit_button') }}"/>
                                </div>
                            </form>
                        </div>
                    </div>
