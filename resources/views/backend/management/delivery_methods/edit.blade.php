                    ...
                    <form method="post" class="kt-form"
                            ...
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="delivery_method_edit_min_amount" name="delivery_method_edit_min_amount"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="delivery_method_edit_max_amount" name="delivery_method_edit_max_amount"
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.delivery_methods.edit.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
