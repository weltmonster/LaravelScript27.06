                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-management-faq-edit-form') }}">
                            ...
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="{{ __('backend/management.faqs.answer') }}">{{ LangHelper::getValue($lang, 'faq', 'answer', $faq->id) ?? (strlen($faq->answer) > 0 ? decrypt($faq->answer) : '') }}</textarea>
                                ...
                                @if($lang == null)
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               id="faq_edit_ordering" name="faq_edit_ordering" placeholder=""
                                               value="{{ $faq->ordering }}"/>
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.faqs.edit.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
