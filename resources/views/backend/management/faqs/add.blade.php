                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-management-faq-add-form') }}">
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control @if($errors->has('faq_add_question')) is-invalid @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="faq_add_category" id="faq_add_category"
                                            class="form-control @if($errors->has('faq_add_category')) is-invalid @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="text-editor form-control @if($errors->has('faq_add_answer')) is-invalid @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           class="form-control @if($errors->has('faq_add_ordering')) is-invalid @endif"
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.faqs.add.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
