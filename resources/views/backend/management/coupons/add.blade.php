    ...
    <div class="k-content__head	k-grid__item">
        <div class="k-content__head-main">
            ...
            <div class="k-content__head-breadcrumbs">
                ...
                <span class="k-content__head-breadcrumb-separator"></span>
                <a href="{{ route('backend-management-coupons') }}"
                   class="k-content__head-breadcrumb-link">{{ __('backend/management.coupons.title') }}</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="form-group">
                                    <label for="coupon_add_is_percent">
                                        <input type="checkbox"
                                               class="form-control @if($errors->has('coupon_add_is_percent')) is-invalid @endif"
...
-->
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.coupons.add.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
