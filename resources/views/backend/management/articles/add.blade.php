    ...
    <div class="k-content__head	k-grid__item">
        <div class="k-content__head-main">
            ...
            <div class="k-content__head-breadcrumbs">
                ...
                <span class="k-content__head-breadcrumb-separator"></span>
                <a href="{{ route('backend-management-articles') }}"
                   class="k-content__head-breadcrumb-link">{{ __('backend/management.articles.title') }}</a>
            </div>
        </div>
    </div>
                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-management-article-add-form') }}">
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.articles.add.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
