                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td style="font-size: 20px;">
                                                <a href="{{ route('backend-management-user-edit', $user->id) }}"><i
                                                        class="la la-edit"></i></a>
                                                <a href="{{ route('backend-management-user-delete', $user->id) }}"><i
                                                        class="la la-trash"></i></a>
                                                <a href="{{ route('backend-management-user-login', $user->id) }}"><i
                                                        class="la la-sign-in"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
