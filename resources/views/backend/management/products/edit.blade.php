    ...
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                ...
                <a href="{{ route('backend-management-product-bonus', $product->id) }}"
                   target="_shop_product_bonus_{{ $product->id }}" class="btn btn-wide btn-bold btn-primary btn-upper"
                   style="margin-bottom:15px">Bonus</a>
                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-management-product-edit-form') }}">
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ LangHelper::getValue($lang, 'product', 'name', $product->id) ?? $product->name }}"/>
                                ...
                                <div class="form-group">
                                    <label
                                        for="product_edit_short_description">{{ __('backend/management.products.short_description') }}</label>
                                    <input type="text"
                                           class="form-control @if($errors->has('product_edit_short_description')) is-invalid @endif"
                                           id="product_edit_short_description" name="product_edit_short_description"
                                           placeholder="{{ __('backend/management.products.short_description') }}"
                                           value="{{ LangHelper::getValue($lang, 'product', 'short_description', $product->id) ?? (strlen($product->short_description) > 0 ? decrypt($product->short_description) : '') }}"/>
                                        ...
                                        <select name="product_edit_category_id" id="product_edit_category_id"
                                            ...
                                            @foreach(App\Models\ProductCategory::all() as $productCategory)
                                                <option value="{{ $productCategory->id }}"
                                                        @if($product->category_id == $productCategory->id) selected @endif>{{ $productCategory->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="{{ __('backend/management.products.description') }}">{{ LangHelper::getValue($lang, 'product', 'description', $product->id) ?? (strlen($product->description) > 0 ? decrypt($product->description) : '') }}</textarea>
                                ...
                                @if($lang == null)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="product_edit_old_price_in_cent" name="product_edit_old_price_in_cent"
                                    ...
                                    <div style="margin-bottom: 5px;">
                                        <label class="k-checkbox k-checkbox--all k-checkbox--solid">
                                            <input type="checkbox" name="product_edit_drop_needed" value="1"
                                                   data-content-visible="false" data-weight-visible="false"
                                                   @if($product->dropNeeded()) checked @endif />
                                            <span></span>
                                    ...
                                    <div class="form-group">
                                        <label class="k-radio k-radio--all k-radio--solid">
                                            <input type="radio" name="product_edit_stock_management" value="normal"
                                                   data-content-visible="false" data-weight-visible="false"
                                    ...
                                    <div class="form-group">
                                        <label class="k-radio k-radio--all k-radio--solid">
                                            <input type="radio" name="product_edit_stock_management" value="weight"
                                                   data-content-visible="true" data-weight-visible="true"
                                                   @if($product->asWeight()) checked @endif />
                                            <span></span>
                                    ...
                                    <div class="form-group">
                                        <label class="k-radio k-radio--all k-radio--solid">
                                            <input type="radio" name="product_edit_stock_management" value="unlimited"
                                    ...
                                    <div class="product_edit_content_div form-group"
                                        ...
                                        <textarea
                                            ...
                                            placeholder="{{ __('backend/management.products.content') }}">{{ strlen($product->content) > 0 ? decrypt($product->content) : '' }}</textarea>
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.products.edit.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
