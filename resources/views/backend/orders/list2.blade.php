    ...
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <a href="{{ route('backend-orders') }}" class="btn btn-wide btn-bold btn-primary btn-upper"
                   style="margin-bottom:15px">Einzelne Bestellungen</a>
                                            ...
                                            <td>
                                                @if(!$shopping->isDone())
                                                    <a href="{{ route('backend-shopping-done', $shopping->id) }}"
                                                       data-toggle="tooltip"
                                                       data-original-title="Als abgearbeitet markieren">Als abgearbeitet
                                                        markieren</a>
                                                    |
                                                @endif
                                                <a href="{{ route('backend-shopping-id', $shopping->id) }}"
                                                   data-toggle="tooltip" data-original-title="Ansehen">Ansehen</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
