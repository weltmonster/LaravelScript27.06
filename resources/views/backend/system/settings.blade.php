                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-system-settings-form') }}">
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="settings_access_only_for_users" id="settings_access_only_for_users"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="register_newsletter_checked" id="register_newsletter_checked"
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/system.settings.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
