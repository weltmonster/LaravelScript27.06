                            ...
                            <div class="col-md-12">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="username"
                                                   class="text-md-right">{{ __('frontend/user.username') }}</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="jabber_id"
                                                   class="text-md-right">{{ __('frontend/user.jabber_id') }}</label>
                                            <input id="jabber_id" type="email"
                                                   class="form-control{{ $errors->has('jabber_id') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="password"
                                                   class="text-md-right">{{ __('frontend/user.register.password') }}</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="password-confirm"
                                                   class="text-md-right">{{ __('frontend/user.register.confirm_password') }}</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="password"
                                                   class="text-md-right">{{ __('frontend/main.captcha') }}</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       id="newsletter_enabled" {{ old('newsletter_enabled') ? 'checked' : App\Models\Setting::get('register.newsletter_enabled') ? 'checked' : '' }}>
