            ...
            var html = '';
               html +=  `<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6"><div class="sell__box theme-bg-dark mb-30 transition-3"><div class="sell__box-thumb m-img mt-20 mb-20">`;
                    if(item.thumbnail_image) {
                        html +=  `<a  class="product-href" href="../product/${item.id}"><img onerror="changeImageToDiv(this, '${item.name}')" class="test" width='100%' height='232' src="{{asset_dir('adminV2/assets/media/product/${item.thumbnail_image}')}}" alt=""></a></div><div class="sell__box-content">`;
                    }else {
                        /* html +=  `<a class="product-href"  href="../product/${item.id}"><div class="image-container text-center"><p class="text">${item.name}</p></div></a></div><div class="sell__box-content">`;*/
                            html += `<a class="product-href" href="../product/${item.id}"><img class="test" width="100%" height="232" src="{{asset_dir('newdesign/assets/img/creator/16838828281.jpg')}}" alt="Demo Image" /></a></div><div class="sell__box-content">`;
                       }
