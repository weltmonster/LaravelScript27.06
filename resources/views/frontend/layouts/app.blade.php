                            ...
                            <div class="container">
                                ...
                                <li class="nav-item">
                                        ...
                                        <li class="nav-item @if(count($productCategories) > 0) dropdown @endif">
                                            ...
                                            @else
                                                <a class="nav-link" href="{{ route('index-with-pageNumber') }}">
                                                    {{ __('frontend/main.shop') }}
                                                </a>
                                            @endif
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="{{ route('index-with-pageNumber') }}">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-left">
                            <span>&copy; 2020 <a href="{{url('/')}}">Selling-Script</a>. All rights reserved.</span>
                        </div>
