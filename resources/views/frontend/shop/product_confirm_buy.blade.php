                                    ...
                                    @foreach(App\Models\DeliveryMethod::all() as $deliveryMethod)
                                        <label class="k-radio k-radio--all k-radio--solid">
                                            <input type="radio" name="product_delivery_method"
                                                   ...
                                                   @if(!$deliveryMethod->isAvailableAmount($totalPriceInCent)) disabled @endif />
                                            <span></span>
                            ...
                            <li class="list-group-item">
                                <div class="text-right">
                                    ...
                                    <a href="{{ route('product-page', $product->id) }}"
                                       class="btn btn-outline-secondary">{{ __('frontend/shop.cancel_order') }}</a>
                                    <button class="btn btn-primary"
                                            @if(!$product->isAvailable()) disabled @endif>{{ __('frontend/shop.confirm') }}</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header" id="faqHeading">
                                <h5 class="mb-0">
                                    <button class="btn btn-link btn-block text-left text-decoration-none"
                                            data-toggle="collapse" data-target="#faqCollapse" aria-expanded="true"
