                ...
                <div class="profile__tab-content">
                    ...
                    <div class="tab-content" id="profile-tabContent">
                        <article class="postbox__item format-image mb-40 transition-3">
                            <div class="blog__grid-tag">
                                <a href="javascript:void(0);"><span
                                        class="tp-btn-2 none">{{ __('frontend/user.tickets.list_tickets') }}</span></a>
                        ...
                        <div class="tab-pane fade active show" id="nav-ticket" role="tabpanel"
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('ticket-id', $ticket->id) }}">{{ substr($ticket->subject, 0, 255) }}</a>
                                            </td>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('ticket-id', $ticket->id) }}">{{ __('frontend/user.tickets.view') }}</a>
                                                <span class="span-divider">|</span>
                                                <a
                                                    href="{{ route('ticket-delete', $ticket->id) }}">{{ __('frontend/user.tickets.delete') }}</a>
                            ...
                            {!! preg_replace('/' . $user_tickets->currentPage() . '\?page=/', '',
                            $user_tickets->links()) !!}
                        </div>
                    </div>
                </div>
