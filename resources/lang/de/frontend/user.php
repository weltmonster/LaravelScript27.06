...
return [
    ...
    'login' => [
        ...
        'error_message' => 'h-captcha-response ist erforderlich.',
    ],
    ...
    'order_review' => [
        'title' => 'Kaufabwicklung abschließen',
        'description' => 'Bitte bewerten Sie die Produktqualität',
        'feedback' => 'Rückmeldung',
        'positive' => 'Positiv',
        'negative' => 'Negativ',
        'submit_feedback' => 'Geben Sie Feedback ab',
    ]
];
