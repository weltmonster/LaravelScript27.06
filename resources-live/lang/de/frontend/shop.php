...
return [
    ...
    'orders' => [
        'status' => [
            'completed' => 'Versandt / Fertiggestellt',
            'cancelled' => 'Stoniert',
    ...
    'products' => [
        ...
        'sold_out' => 'Ausverkauft',
        'amount_in_stock' => ':amount auf lager',
    ],
    ...
    'product_page' => [
        ...
        'price' => 'Preis',
        'quantity' => 'Menge',
        'buy_now_btn' => 'Kaufe jetzt',
        'product_sold_amount' => 'Produkt wurde :amount Mal verkauft',
        'total' => 'Gesamt',
        'amount_to_pay' => 'Zu zahlender Betrag',
        'confirm_order' => 'Bestellung bestätigen',
        'is_balance' => 'Das Guthaben reicht nicht aus, um dieses Produkt zu kaufen',
        'login_to_buy' => 'Um Einkäufe zu tätigen, müssen Sie eingeloggt/registriert sein.'
    ],
