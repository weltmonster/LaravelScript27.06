                        ...
                        <form method="POST" action="{{ route('backend-jabber-newsletter-form') }}" style="width: 100%;">
                            ...
                            <div class="form-group" style="width: 100%;">
                                ...
                                <textarea style="width: 100%;"
                                          class="form-control @if($errors->has('jabber_message')) is-invalid @endif"
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-wide btn-bold btn-danger"
                                       value="{{ __('backend/jabber.newsletter.submit_button') }}"/>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <form method="POST" action="{{ route('backend-jabber-login-form') }}" style="width: 100%;">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input style="width: 100%;"
                                           class="form-control @if($errors->has('jabber_address')) is-invalid @endif"
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input style="width: 100%;"
                                           class="form-control @if($errors->has('jabber_username')) is-invalid @endif"
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input style="width: 100%;"
                                           class="form-control @if($errors->has('jabber_password')) is-invalid @endif"
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-wide btn-bold btn-danger"
                                           value="{{ __('backend/jabber.login.save') }}"/>
                                </div>
                            </form>
                        </div>
                    </div>
