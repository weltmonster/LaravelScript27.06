        ...
        <div class="k-content__head-main">
            ...
            <div class="k-content__head-breadcrumbs">
                ...
                <a href="{{ route('backend-management-product-edit', $product->id) }}"
                   class="k-content__head-breadcrumb-link">{{ $product->name }}</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="k-portlet__body">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ count(App\Models\ProductItem::where('product_id', $product->id)->get()) }}</div>
                                ...
                                <div class="">
                                    <div class="col-md-6" style="padding:0;margin:0;">
                                        <input type="text" class="form-control" name="search_input"
                                               value="{{ $search ?? '' }}" placeholder="Suchbegriff eingeben..."/>
                                        <br/>
                                        <label>
                                            <input type="checkbox" class="checkbox" name="search_regex"
                                                   @if(isset($regex) && $regex) checked @endif/> Regex?
                                        </label>
                                        <br/>
            ...
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <form method="POST" action="{{ route('backend-management-product-database-import-txt') }}"
                              style="width: 100%;">
                            @csrf
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <form method="POST" action="{{ route('backend-management-product-database-import-one') }}"
                              style="width: 100%;">
                            @csrf
