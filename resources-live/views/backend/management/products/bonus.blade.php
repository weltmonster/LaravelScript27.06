                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="settings_bonus_amount_{{ $b->id }}" placeholder="100"
                                                   value="{{ $b->min_amount }}"/>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="settings_bonus_percent_{{ $b->id }}" placeholder="0.90"
                                                   value="{{ $b->percent }}"/>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="settings_bonus_amount_new" name="settings_bonus_amount_new"
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="settings_bonus_percent_new" name="settings_bonus_percent_new"
                                               placeholder="0.90" value=""/>
