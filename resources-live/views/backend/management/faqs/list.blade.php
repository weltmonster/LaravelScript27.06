    ...
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <a href="{{ route('backend-management-faq-add') }}" class="btn btn-wide btn-bold btn-primary btn-upper"
                                    ...
                                    @foreach($faqs as $faq)
                                        <tr>
                                            ...
                                            <td style="font-size: 20px;">
                                                <a href="{{ route('backend-management-faq-edit', $faq->id) }}"><i
                                                        class="la la-edit"></i></a>
                                                <a href="{{ route('backend-management-faq-delete', $faq->id) }}"><i
