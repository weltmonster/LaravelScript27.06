                    ...
                    <form method="post" class="kt-form"
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control @if($errors->has('faq_category_edit_name')) is-invalid @endif"
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.faqs.categories.edit.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
