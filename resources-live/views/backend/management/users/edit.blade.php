...
@section('content')
    <div class="k-content__head	k-grid__item">
        <div class="k-content__head-main">
            ...
            <div class="k-content__head-breadcrumbs">
                ...
                <span class="k-content__head-breadcrumb-separator"></span>
                <a href="{{ route('backend-management-users') }}"
                   class="k-content__head-breadcrumb-link">{{ __('backend/management.users.title') }}</a>
            </div>
        </div>
    </div>
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                <a href="{{ route('backend-management-user-tickets', $user->id) }}"
                   class="btn btn-wide btn-bold btn-primary btn-upper" style="margin-bottom:15px">Alle Tickets</a>
                <a href="{{ route('backend-management-user-orders', $user->id) }}"
                   class="btn btn-wide btn-bold btn-primary btn-upper" style="margin-bottom:15px">Alle Bestellungen</a>
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\UserTransaction::where('user_id', $user->id)->count() }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\UserTicket::where('user_id', $user->id)->count() }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
                ...
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\UserOrder::where('user_id', $user->id)->count() }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
                ...
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <div class="k-portlet__body k-portlet__body--fluid">
                        <div class="k-widget-20">
                            <div class="k-widget-20__title">
                                <div
                                    class="k-widget-20__label">{{ App\Models\UserPermission::where('user_id', $user->id)->count() }}</div>
                                <img class="k-widget-20__bg"
                                     src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg"/>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <div class="k-portlet">
                    ...
                    <div class="k-portlet__body">
                        <div
                            class="k-datatable k-datatable--default k-datatable--brand k-datatable--error k-datatable--loaded k-datatable--scroll"
                            id="k_recent_tickets">
                            <table class="table">
                                <thead class="">
                                <tr>
                                ...
                                @foreach($tickets as $ticket)
                                    <tr>
                                        ...
                                        <td>
                                            @if($ticket->isClosed())
                                                <span
                                                    class="kt-badge kt-badge--danger kt-badge--dot kt-badge--md"></span>
                                                <span
                                            ...
                                            @elseif($ticket->isReplied())
                                                <span
                                                    class="kt-badge kt-badge--brand kt-badge--dot kt-badge--md"></span>
                                                <span
                                                    class="kt-label-font-color-2 kt-font-bold">{{ __('backend/dashboard.recent_tickets.status_data.replied') }}</span>
                                            @else
                                                <span
                                                    class="kt-badge kt-badge--success kt-badge--dot kt-badge--md"></span>
                                                <span
                    ...
                    <form method="post" class="kt-form" action="{{ route('backend-management-user-edit-form') }}">
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control @if($errors->has('user_edit_name')) is-invalid @endif"
                                           id="user_edit_name" name="user_edit_name"
                                           placeholder="{{ __('backend/management.users.name') }}"
                                           value="{{ $user->name }}"/>
                                ...
                                <div class="form-group">
                                    <label
                                        for="user_edit_username">{{ __('backend/management.users.username') }}</label>
                                    <input type="text"
                                           class="form-control @if($errors->has('user_edit_username')) is-invalid @endif"
                                           id="user_edit_username"
                                           placeholder="{{ __('backend/management.users.username') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control @if($errors->has('user_edit_jabber')) is-invalid @endif"
                                           id="user_edit_jabber" name="user_edit_jabber"
                                           placeholder="{{ __('backend/management.users.jabber') }}"
                                           value="{{ $user->jabber_id }}"/>
                                ...
                                <div class="form-group">
                                    <label
                                        for="user_edit_balance">{{ __('backend/management.users.balance_in_cent') }}</label>
                                    <input type="number"
                                           class="form-control @if($errors->has('user_edit_balance')) is-invalid @endif"
                                           id="user_edit_balance" name="user_edit_balance"
                                           placeholder="{{ __('backend/management.users.balance') }}"
                                           value="{{ $user->balance_in_cent }}"/>
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <button type="submit"
                                        class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.users.edit.submit_button') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                    <div class="kt-portlet">
                        ...
                        <form method="post" class="kt-form"
                              action="{{ route('backend-management-user-update-permissions-form') }}">
                            @csrf
                                    ...
                                    @foreach(App\Models\Permission::all() as $permission)
                                        <div class="form-group">
                                            <label class="k-checkbox k-checkbox--all k-checkbox--solid">
                                                <input type="checkbox" name="user_edit_permissions[]"
                                                       value="{{ $permission->id }}"
                                                       @if($user->hasPermission($permission->permission)) checked @endif />
                                                <span></span>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <button type="submit"
                                            class="btn btn-wide btn-bold btn-danger">{{ __('backend/management.users.edit.save_button') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
