    ...
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <a href="{{ route('backend-shoppings') }}" class="btn btn-wide btn-bold btn-primary btn-upper"
                   style="margin-bottom:15px">Mehrfach Bestellungen</a>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 20px;">
                                                ...
                                                <a href="{{ route('backend-order-delete', $order->id) }}"
                                                   data-toggle="tooltip"
                                                   data-original-title="{{ __('backend/orders.delete') }}"><i
