                        ...
                        <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                            <div class="kt-portlet">
                                ...
                                <form method="post" class="kt-form"
                                      action="{{ route('backend-management-article-add-form') }}">
                                    @csrf
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                                <label
                                                    for="article_add_title">{{ __('backend/management.articles.article_title') }}</label>
                                                <input type="text"
                                                       class="form-control @if($errors->has('article_add_title')) is-invalid @endif"
                                                       id="article_add_title" name="article_add_title"
                                                       placeholder="{{ __('backend/management.articles.article_title') }}"
                                                       value="{{ old('article_add_title') }}"/>
                                            ...
                                            <div class="form-group mt-5">
                                                <label
                                                    for="article_add_content">{{ __('backend/management.articles.content') }}</label>
                                                <textarea
                                                    class="text-editor form-control @if($errors->has('article_add_content')) is-invalid @endif"
                                                    id="article_add_content" name="article_add_content"
                                                    placeholder="{{ __('backend/management.articles.content') }}">{{ old('article_add_content') }}</textarea>
                                            ...
                                            <div class="form-group form-check-custom form-check-solid mt-5">
                                                <div
                                                    class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                    <input class="form-check-input" type="checkbox"
                                                           name="article_add_anonym"/>
                                                    <label>{{ __('backend/management.articles.add.anonym') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit"
                                                    class="btn btn-primary">{{ __('backend/management.articles.add.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
