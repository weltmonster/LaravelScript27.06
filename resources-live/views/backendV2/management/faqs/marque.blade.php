        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <a href="{{ route('backend-management-marque-add') }}"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users"
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-275px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                colspan="1">Marque Text
                            </th>
                            <th class="min-w-275px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                colspan="1" style="text-align: end;">{{ __('backend/management.faqs.actions') }}</th>
                        </tr>
                        </thead>
                                    ...
                                    <tr>
                                        <td>
                                            <div
                                                ...
                                                <input class="form-check-input orderCheck" data-id="{{ $marque->id }}"
                                                       type="checkbox"/>
                                            </div>
                                        </td>
                                        ...
                                        <td style="font-size: 20px; text-align: end;">
                                            <a href="{{ route('backend-management-marque-edit', $marque->id) }}"><i
                                                    class="la la-edit"></i></a>
                                            <a href="{{ route('backend-management-marque-delete', $marque->id) }}"><i
