...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link href="{{ asset_dir('adminV2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}"
            rel="stylesheet" type="text/css" />
        <link href="{{ asset_dir('adminV2/assets/plugins/custom/datatables/datatables.bundle.css')}}" rel="stylesheet"
            type="text/css" />
        {{-- <!--end::Vendor Stylesheets--> --}}
        {{-- <!--begin::Global Stylesheets Bundle(mandatory for all pages)--> --}}
        <link href="{{ asset_dir('adminV2/assets/plugins/global/plugins.bundle.css')}}" rel="stylesheet"
            type="text/css" />
