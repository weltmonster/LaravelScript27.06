...
<div id="kt_header" class="header">
    ...
    <div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
        <!--begin::Page title-->
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#"', lg: ' #kt_header_container'}">
            <!--begin::Heading-->
            <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1"> @yield('pageTitle')@yield('shopButton')
                ...
                <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary w-40px h-40px" id="kt_activities_toggle" style="position: relative;">
                    ...
                    <span class="svg-icon svg-icon-1" data-bs-toggle="modal" data-bs-target="#exampleModal" id="unread-data" onclick="readNotification()">
                        <a href="#" class="notification">
                            <span style="vertical-align: inherit; margin-top: -13px; margin-left: 11px; color:red; position: absolute;">{{
                                Session::put('read', App\Models\Notification::count() ) }}
