                ...
                <div class="card">
                    ...
                    <div id="btc-cashin" class="card-body">
                        <div class="btc-cashin-box">
                            ...
                            <img class="btc-cashin-img"
                                 src="https://chart.googleapis.com/chart?chs=180x180&chld=L|0&cht=qr&chl=bitcoin:{{ $btcWallet }}"/>

                            <input id="btc-cashin-wallet" type="text" onClick="this.select();" class="btc-cashin-input"
                                   value="{{ $btcWallet }}" readonly/>

                            <a href="javascript:void(0);" class="btc-cashin-copy-btn"
                               data-clipboard-target="#btc-cashin-wallet">
                            ...
                            <form method="POST" action="{{ route('deposit-btc-post', $userTransactionID) }}">
                                ...
                                <button type="submit"
                                        class="btn btn-primary">{{ __('frontend/user.i_paid_button') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
