        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('deposit-btc') }}"
                           class="btn btn-warning btn-cashin @if(!App\Classes\BitcoinAPI::connected()) disabled @endif">{{ __('frontend/user.cashin_btc_button') }}</a>
                    </div>
                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <label for="coupon_redeem_code"
                                           class="text-md-right">{{ __('frontend/user.coupon_redeem.code') }}</label>
                                    <input id="coupon_redeem_code" type="text"
                                           class="form-control{{ $errors->has('coupon_redeem_code') ? ' is-invalid' : '' }}"
