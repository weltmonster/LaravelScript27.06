                ...
                <div class="card">
                    ...
                    <div id="eth-cashin" class="card-body">
                        <div class="eth-cashin-box">
                            ...
                            <img class="eth-cashin-img"
                                 src="https://chart.googleapis.com/chart?chs=180x180&chld=L|0&cht=qr&chl={{ $ethWallet }}"/>

                            <input id="eth-cashin-wallet" type="text" onClick="this.select();" class="eth-cashin-input"
                                   value="{{ $ethWallet }}" readonly/>

                            <a href="javascript:void(0);" class="eth-cashin-copy-btn"
                               data-clipboard-target="#eth-cashin-wallet">
