                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="settings_current_password"
                                           class="text-md-right">{{ __('frontend/user.settings_current_password') }}</label>

                                    <input id="settings_current_password" type="password"
                                           class="form-control{{ $errors->has('settings_current_password') ? ' is-invalid' : '' }}"
                                           name="settings_current_password"
                                           value="{{ old('settings_current_password') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="settings_new_password"
                                           class="text-md-right">{{ __('frontend/user.settings_new_password') }}</label>

                                    <input id="settings_new_password" type="password"
                                           class="form-control{{ $errors->has('settings_new_password') ? ' is-invalid' : '' }}"
                                           name="settings_new_password" value="{{ old('settings_new_password') }}"
                                           required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <label for="settings_new_password_confirm"
                                           class="text-md-right">{{ __('frontend/user.settings_new_password_confirm') }}</label>
                                    <input id="settings_new_password_confirm" type="password"
                                           class="form-control{{ $errors->has('settings_new_password_confirm') ? ' is-invalid' : '' }}"
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('settings-jabber-id-change') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <label for="settings_jabber_id"
                                           class="text-md-right">{{ __('frontend/user.settings_jabber_id') }}</label>
                                    <input id="settings_jabber_id" type="email" value="{{ Auth::user()->jabber_id }}"
                                           class="form-control{{ $errors->has('settings_jabber_id') ? ' is-invalid' : '' }}"
                                           name="settings_jabber_id" value="{{ old('settings_jabber_id') }}" required
                                           autofocus>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="newsletter_enabled"
                                               id="newsletter_enabled" {{ Auth::user()->newsletter_enabled ? 'checked' : App\Models\Setting::get('settings_newsletter_enabled') ? 'checked' : '' }}>
