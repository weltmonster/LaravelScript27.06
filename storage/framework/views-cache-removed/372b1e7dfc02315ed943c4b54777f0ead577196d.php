                                ...
                                <form method="post" class="kt-form" action="<?php echo e(route('backend-management-product-edit-form')); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <textarea class="text-editor form-control <?php if($errors->has('product_edit_description')): ?> is-invalid <?php endif; ?>" id="product_edit_description" name="product_edit_description" placeholder="<?php echo e(__('backend/management.products.description')); ?>"><?php echo e(__(':description', ['description' => $product->description])); ?></textarea>
                                            ...
                                            <div class="form-group mt-5">
                                                <label for="product_edit_image"><?php echo e(__('backend/management.products.images')); ?></label>
                                                <input type="file" class="form-control <?php if($errors->has('product_edit_image')): ?> is-invalid <?php endif; ?>" id="product_edit_description" name="product_edit_image"  />
                                            ...
                                            <?php if($lang == null): ?>
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" step="" class="form-control <?php if($errors->has('product_edit_price_in_cent')): ?> is-invalid <?php endif; ?>" id="product_edit_price_in_cent" name="product_edit_price_in_cent" placeholder="<?php echo e(__('backend/management.products.price_in_cent_example')); ?>" value="<?php echo e($product->price_in_cent); ?>" />
                                                ...
                                                <div class="form-check form-check-custom form-check-solid form-check-sm mt-5">
                                                    <input type="radio" id="product_add_stock_management1" class="form-check-input" name="product_edit_stock_management" value="normal" data-content-visible="false" data-weight-visible="false" <?php if(!$product->isUnlimited() && !$product->asWeight()): ?> checked <?php endif; ?> />
                                                ...
                                                <div class="form-check form-check-custom form-check-solid form-check-sm mt-5">
                                                    <input class="form-check-input" id="product_add_stock_management2" type="radio" name="product_edit_stock_management" value="unlimited" data-content-visible="true" data-weight-visible="false" <?php if($product->isUnlimited()): ?> checked <?php endif; ?> />
                                                ...
                                                <div class="product_edit_content_div mt-5 form-group" style="<?php if(!$product->isUnlimited() && !$product->asWeight()): ?> display: none; <?php endif; ?>">
                                                    ...
                                                    ?>
                                                    <textarea class="text-editor form-control <?php if($errors->has('product_edit_content')): ?> is-invalid <?php endif; ?>" id="product_edit_content" name="product_edit_content" placeholder="<?php echo e(__('backend/management.products.content')); ?>"><?php echo e($value); ?></textarea>
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit" class="btn btn-primary"><?php echo e(__('backend/management.products.edit.submit_button')); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    $(document).ready(function(){
        ...
        if(currencyvalue == 'euro'){
            ...
            $('#product_edit_price_in_cent').on('keyup', function(e){
                //alert(.val());
                if(e.keyCode == 8){
                    return
                }
            ...
            $('#product_edit_old_price_in_cent').on('keyup', function(e){
                //alert(.val());
                if(e.keyCode == 8){
                return
                }
        ...
        $('body #product_edit_price_in_cent').trigger('keyup');
        $('body #product_edit_old_price_in_cent').trigger('keyup');
    });
</script>
...
<?php echo $__env->make('backendV2.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/backendV2/management/products/edit.blade.php ENDPATH**/ ?>