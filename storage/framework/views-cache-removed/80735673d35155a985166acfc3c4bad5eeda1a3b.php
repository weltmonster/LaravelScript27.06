              ...
              <div class="col-xxl-6 col-xl-6 col-lg-8">
                 <div class="login__wrapper">
                    ...
                    <div class="login__top text-center">
                       ...
                       <p>Don't have an account yet? <a href="<?php echo e(route('register')); ?>"><?php echo e(__('frontend/user.login.create_account')); ?></a></p>
                    </div>
                    ...
                    <div class="login__form">
                       <form method="POST" action="<?php echo e(route('login')); ?>">
                          ...
                          <div class="login__input-box">
                             ...
                             <div class="login__input">
                                 <div class="inputField">
                                    <input required id="email" type="text" class="<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" value="<?php echo e(old('email')); ?>">
                          ...
                          <div class="login__input-box">
                             ...
                             <div class="login__input">
                                 <div class="inputField">
                                     <input required id="password" type="password" class="<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password">
                                     <span class="login__input-icon">
...
<?php echo $__env->make('frontend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/frontend/auth/newlogin.blade.php ENDPATH**/ ?>