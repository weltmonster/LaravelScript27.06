<?php $__env->startSection('pageTitle', __('backend/system.settings.title') ); ?>
                                        ...
                                        <?php $__currentLoopData = $bbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="kt-section kt-section--first row">
                                                ...
                                                <div class="col-md-2" style="padding-top:35px">
                                                    ...
                                                    <a href="<?php echo e(route('backend-system-bonus-del', $b->id)); ?>"
                                                       class="btn btn-primary">Löschen</a>
                                                </div>
                                            </div>
...
<?php echo $__env->make('backendV2.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/backendV2/system/bonus.blade.php ENDPATH**/ ?>