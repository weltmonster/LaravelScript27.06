                                                    ...
                                                    <!--
                                                            <div class="nft__box-bottom d-flex align-items-center justify-content-between">
                                                                <div class="nft__box-highest">
                                                                    <p>
                                                                        <button type="submit" class="btn btn-icon btn-block btn-primary buyButton"  onclick="window.location.href='<?php echo e(route('product-page', $product->id)); ?>'"><?php echo e(__('frontend/v4.buybtn')); ?></button>
                                                                    </p>
                                                                </div>
                                                            </div>-->
                                                    <?php endif; ?>
            ...
            var html = '';
               html +=  `<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6"><div class="nft__box theme-bg-dark mb-30 transition-3"><div class="nft__box-thumb m-img mt-20 mb-20">`;
                    if(item.thumbnail_image) {
                        html +=  `<a  class="product-href" href="../product/${item.id}"><img onerror="changeImageToDiv(this, '${item.name}')" class="test" width='100%' height='232' src="<?php echo e(asset_dir('adminV2/assets/media/product/${item.thumbnail_image}')); ?>" alt=""></a></div><div class="nft__box-content">`;
                    }else {
                        // html +=  `<a class="product-href"  href="../product/${item.id}"><div class="image-container text-center"><p class="text">${item.name}</p></div></a></div><div class="nft__box-content">`;
                            html += `<a class="product-href" href="../product/${item.id}"><img class="test" width="100%" height="232" src="<?php echo e(asset_dir('newdesign/assets/img/creator/16838828281.jpg')); ?>" alt="Demo Image" /></a></div><div class="nft__box-content">`;
                       }
...
<?php echo $__env->make('frontend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/frontend/index.blade.php ENDPATH**/ ?>