                        ...
                        <div class="kt-portlet">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                                ...
                                                <!-- <form id="image-upload-logo" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group mt-5">
                                                        ...
                                                        <?php if($errors->has('logo')): ?>
                                                         ...
                                                         <?php endif; ?>
                                                         <input type="hidden" name="hidden_val" value="<?php echo e($shopLogo->value); ?>">
                                                    </div>
                                                    <div>
                                                        <span>
                                 ...
                                 <div class="col-md-2">
                                    <?php if(!empty($shopLogo->value)): ?>
                                     <img src="<?php echo e(asset('newdesign/assets/img/creator').'/'.$shopLogo->value); ?>" class="logo_img" alt="">
                                    <?php endif; ?>
                                 </div>
                                 <div class="col-md-1">
                                 <?php if(!empty($shopLogo->value)): ?>  
                                ...
                                <?php if(!empty($shopBanner->value)): ?>  
                                    <img src="<?php echo e(asset('newdesign/assets/img/creator').'/'.$shopBanner->value); ?>" class="banner_img" alt="">
                                <?php endif; ?>  
                                </div>
                                 <div class="col-md-1">
                                 <?php if(!empty($shopBanner->value)): ?>  
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 30%;">News Ticker</th>
