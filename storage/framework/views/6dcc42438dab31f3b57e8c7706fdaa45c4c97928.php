                                ...
                                <form method="post" class="kt-form"
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                                <label
                                                    for="faq_add_question"class="page-add"><?php echo e(__('backend/management.faqs.question')); ?></label>
                                                <input type="text"
                                                       class="form-control page-add <?php if($errors->has('faq_add_question')): ?> is-invalid <?php endif; ?>"
                                            ...
                                            <div class="form-group mt-5">
                                                <label
                                                    for="faq_add_category"class="page-add"><?php echo e(__('backend/management.faqs.category')); ?></label>
                                                <select name="faq_add_category" id="faq_add_category"
                                                        class="form-control page-add <?php if($errors->has('faq_add_category')): ?> is-invalid <?php endif; ?>">
                                            ...
                                            <div class="form-group mt-5">
                                                <label
                                                    for="faq_add_answer"class="page-add"><?php echo e(__('backend/management.faqs.answer')); ?></label>
                                                <textarea
                                                    class="text-editor form-control page-add <?php if($errors->has('faq_add_answer')): ?> is-invalid <?php endif; ?>"
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <input type="number"
                                                       class="form-control page-add <?php if($errors->has('faq_add_ordering')): ?> is-invalid <?php endif; ?>"
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit"
                                                    class="btn btn-primary submit"><?php echo e(__('backend/management.faqs.add.submit_button')); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
