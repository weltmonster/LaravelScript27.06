...
<?php $__env->startSection('pageTitle', __('Welcome back, Jenny')); ?>
                ...
                <div class="card card-xl-stretch mb-xl-0 theme-dark-bg-body card_main_2">
                   <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            ...
                            <!--end::Title-->
                            <!--begin::Chart-->
                         <div class="main_view text-dark fs-3x me-2 ">780,192</div>
                            <!-- <div class="mixed-widget-13-chart" style="height: 100px"></div> -->
                ...
                <div class="card card-xl-stretch mb-xl-0 theme-dark-bg-body card_main_3">
                   <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            ...
                            <!--end::Title-->
                            <!--begin::Chart-->
                         <div class="main_view text-dark fs-3x me-2 ">2625.991</div>
                            <!-- <div class="mixed-widget-13-chart" style="height: 100px"></div> -->
                ...
                <div class="card card-xl-stretch mb-xl-0 theme-dark-bg-body card_main_4">
                   <div class="card-body d-flex flex-column">
                        ...
                        <div class="pt-5 bottom_work last">
                            <!--begin::Number-->
                            <span class="red_alert"> <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            ...
                            <a href="#" class="text-dark fs-3"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <?php echo e(__('backend/dashboard.tickets_total.widget_title')); ?></a>
                            <!--end::Title-->
                            <!--begin::Chart-->
...
<?php echo e(__('backend/dashboard.products_total.widget_title')); ?></a>
                            <!--end::Title-->
                            <!--begin::Chart-->
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-0 theme-dark-bg-body" style="background-color: #CBD4F4">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column mb-7">
                            <!--begin::Title-->
                            <a href="#" class="text-dark fs-3"><?php echo e(__('backend/dashboard.articles_total.widget_title')); ?> & <?php echo e(__('backend/dashboard.newsletter_total.widget_title')); ?></a>
                            <!--end::Title-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Row-->
                        <div class="row g-0">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center mb-9 me-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="fs-5 text-dark  lh-1"><?php echo e(App\Models\Article::count()); ?></div>
                                        <div class="fs-7 text-gray-600 "><?php echo e(__('backend/dashboard.articles_total.widget_title')); ?></div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
...
<?php echo e(__('backend/dashboard.users_total.widget_title')); ?> & <?php echo e(__('backend/dashboard.total_orders.widget_title')); ?> </a>
                            <!--end::Title-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Row-->
...
<?php echo e(__('backend/dashboard.today_profit')); ?></a>
                            <!--end::Title-->
                            <!--begin::Chart-->
                            <!-- <div class="" style="height: 100px"></div> -->
...
<?php echo e(__('backend/dashboard.bestseller.widget_title')); ?></a>
                            <!--end::Title-->
                            <!--begin::Chart-->
                            <!-- <div class="" style="height: 100px"></div> -->
                        ...
                        <div class="pt-2">
                            ...
                            <span class="value"><?php echo e($bestsellerProduct->getFormattedPrice()); ?></span>
                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark fs-6"><?php echo e($userOrderCustomer->username ?? 'UNKNOWN'); ?></a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="d-flex flex-column w-100 me-2">
                                        <div class="d-flex flex-stack mb-2">
                                            <span class="text-  me-2 fs-7"><?php echo e($orders->getFormattedPrice()); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark  s fs-6"><?php echo e(helperdateFormat($orders->created_at)); ?> </a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
