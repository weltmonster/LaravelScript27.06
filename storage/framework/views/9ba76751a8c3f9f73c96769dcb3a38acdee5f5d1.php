...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .Pey__ment_form input,
        .Pey__ment_form select {
        ...
        .Pey__ment_form input:focus-visible,
        .Pey__ment_form select:focus-visible {
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="row dasboard_graph_2">
                <!--begin::Col-->
                <div class="col-xl-4">
                    <div class="Left_balance_side p-9">
                        <div class="balance_text">
                            <div class="form__below">
                                <form class="Pey__ment_form">
                                    <div class="mb-5 mt-2">
                                        <label for="exampleInputaddres" class="form-label addres_field">Destination
                                            Address</label>
                                        <input type="text" class="form-control m-0 bg-transparent text-white"
                                            id="exampleInputaddres" placeholder="ghsdvj652fvnk8vd" aria-describedby="Help">
                                    </div>
                                    <div class="mb-5">
                                        <label for="amount" class="form-label addres_field">Amount</label>
                                        <div style="position: relative;">
                                            <span
                                                style="position: absolute; right: 50px; top: 13px; color: #BBB; font-size: 20px;">USD</span>
                                    ...
                                    <div class="mb-5">
                                        <label for="amount_below" class="form-label addres_field">Transaction fee per byte
                                            transferred</label>
                                        <div style="position: relative;">
                                            <span
                                                style="position: absolute; right: 50px; top: 13px; color: #BBB; font-size: 20px;">BTC</span>
                                            <img class="currency-image" style="position: absolute; left: 15px; top: 16px;">
                                            <select style="padding-left:50px; color: #F7B118;" class="form-select bg-transparent currency-select"
                ...
                <div class="col-xl-8">
                    ...
                    <div class="sal-graph-card mb-10 p-7">
                        ...
                        <div>
                            <canvas id="myChart" width="1044" height="380"
                                style="display: block; box-sizing: border-box; height: 380px; width: 1044px;"></canvas>
                        </div>
                    </div>
                    <!--end::Mixed Widget 14-->

                    <!--second part start here -->
                    <div class="card mb-5 mb-xl-10 table_offer p-7">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users"
                                ...
                                <thead style=" width: 100%">
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"
                                        ...
                                        <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1">ID</th>
                                        <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1">Product</th>
                                        <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users"
                                ...
                                <tbody class="text-gray-600 fw-semibold" style="width: 100%">
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="121"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">121</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="120"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">120</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="119"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">119</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="118"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">118</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="117"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">117</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="116"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">116</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="115"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">115</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="114"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">114</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="113"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">113</th>
                                    ...
                                    <tr style="width: 100%">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input orderCheck" data-id="112"
                                                    type="checkbox">
                                            </div>
                                        </td>
                                        <th scope="row">112</th>
...
<?php $__env->startSection('page_scripts'); ?>
    ...
    <script>
        $('.currency-image').attr('src', '/public/asset/images/btc.png')
...
<?php echo $__env->make('backendV2.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work\Figma-Laravel\LaravelScript27.06\resources\views/backendV2/system/payments.blade.php ENDPATH**/ ?>