         ...
         <div class="col-xxl-6 col-xl-6 col-lg-8">
            <div class="login__wrapper">
               ...
               <div class="login__top text-center">
                  ...
                  <p>Already have an account? <a href="<?php echo e(route('login')); ?>"><?php echo e(__('frontend/user.login.submit')); ?> </a>
                  </p>
               </div>
                        ...
                        <div class="login__input">
                           <div class="inputField">
                              <input required id="username" type="text"
                                 class="<?php echo e($errors->has('username') ? ' is-invalid' : ''); ?>" name="username"
               ...
               <div class="login__input">
                  <div class="inputField">
                     <input required id="password" type="password"
                        class="password <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password">
                     <span class="login__input-icon">
