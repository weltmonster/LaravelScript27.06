                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users"
                        ...
                        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input orderCheck" data-id="<?php echo e($ticket->id); ?>"
                                               type="checkbox"/>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php if($ticket->isClosed()): ?>
                                        ...
                                        <span
                                            class="kt-label-font-color-2 kt-font-bold"><?php echo e(__('backend/dashboard.recent_tickets.status_data.closed')); ?></span>
                                    <?php elseif($ticket->isReplied()): ?>
                                        <span class="kt-badge kt-badge--brand kt-badge--dot kt-badge--md"></span>
                                        <span
                                            class="kt-label-font-color-2 kt-font-bold"><?php echo e(__('backend/dashboard.recent_tickets.status_data.replied')); ?></span>
                                    <?php else: ?>
                                        <span class="kt-badge kt-badge--success kt-badge--dot kt-badge--md"></span>
                                        <span
                                            class="kt-label-font-color-2 kt-font-bold"><?php echo e(__('backend/dashboard.recent_tickets.status_data.open')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td style="text-align:right;">
                                    <a href="<?php echo e(route('backend-management-ticket-edit', $ticket->id)); ?>"
...
<?php echo $__env->make('backendV2.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/backendV2/management/users/tickets.blade.php ENDPATH**/ ?>