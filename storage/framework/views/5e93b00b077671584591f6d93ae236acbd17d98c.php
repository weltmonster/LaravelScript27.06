                            ...
                            <nav>
                                <div class="nav nav-tabs" id="product-nav-tab" role="tablist">
                                    <span class="nav-link active"
                                        id="nav-details-tab"><?php echo app('translator')->get('frontend/shop.product_page.description'); ?></span>
                                </div>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="product__details-info-bottom ">
                        <div class="product__details-bid d-sm-flex align-content-center justify-content-between">
                            <div class="product__details-bid-status mb-15">
                                ...
                                <?php if($product->old_price_in_cent > $product->price_in_cent && $product->old_price_in_cent
                                ...
                                <h4 style="margin-bottom: 5px;">
                                    <del><?php echo e($product->getFormatted_old_price_in_cent()); ?></del>&nbsp&nbsp&nbsp<?php echo e($product->getFormattedFrontPrice()); ?>

                                </h4>

                                <p style="margin-bottom: 8px;">You Save
                                    <?php echo e($product->getFormattedSalePer($calculateReverse)); ?>%
                                </p>
                                <style>
                        ...
                        <form id="oneClickCheckout" action="<?php echo e(url('buy-one-click')); ?>" method="post">
                            ...
                            <div class="product__details-info-btn" style="">
                                ...
                                <button type="button" class="tp-btn-2 active"
                                    onclick="<?php echo e(!empty(auth()->user()) ? 'prepareProductPriceByQty()' : 'showAuthError()'); ?>">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="share__modal-content text-center">
                ...
                <div class="total_info-head">
                    <div class="total_info-name">
                        ...
                        <span><?php echo app('translator')->get('frontend/shop.product_page.product_sold_amount', ['amount' =>
                    ...
                    <div class="modal_image_product">
                        <div class="image_product">
                            <?php if($product->thumbnail_image): ?>
                            <img src="<?php echo e(asset_dir('adminV2/assets/media/product/'.$product->thumbnail_image)); ?>"
                                alt="" />
                            <?php else: ?>
            ...
            <div class="total_info-btn">
                <button id="popup-total" type="submit" value="<?php echo app('translator')->get('frontend/shop.product_page.confirm_order'); ?>"
                    onclick="submitForm()"
                    class="tp-btn-2 active"><?php echo app('translator')->get('frontend/shop.product_page.confirm_order'); ?></button>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u979267624/domains/laravel-site.net/public_html/resources/views/frontend/shop/product.blade.php ENDPATH**/ ?>