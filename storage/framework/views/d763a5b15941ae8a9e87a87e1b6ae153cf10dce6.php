                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="topbtn d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--   class="btn btn-primary"><?php echo e(__('backend/management.tickets.go_to_shop')); ?></a>-->
                               <a href="<?php echo e(route('backend-management-ticket-category-add')); ?>"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users"
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                colspan="1"><?php echo e(__('backend/management.tickets.categories.id')); ?></th>
                            <th class="min-w-200px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                colspan="1"><?php echo e(__('backend/management.tickets.categories.name')); ?></th>
                            <th class="min-w-325px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                colspan="1"><?php echo e(__('backend/management.tickets.categories.actions')); ?></th>
                        </tr>
                        </thead>
                        ...
                        <?php $__currentLoopData = $ticketsCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <!--        <input class="form-check-input orderCheck" data-id="<?php echo e($ticketCategory->id); ?>"-->
                                <!--               type="checkbox"/>-->
                                <!--    </div>-->
                                <!--</td>-->
                                ...
                                <td class="eddlt-icon">
                                    <a href="<?php echo e(route('backend-management-ticket-category-edit', $ticketCategory->id)); ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="<?php echo e(route('backend-management-ticket-category-delete', $ticketCategory->id)); ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('backendV2.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u639317863/domains/laravel-site.net/public_html/laravelsite-app/resources/views/backendV2/management/tickets/categories/list.blade.php ENDPATH**/ ?>