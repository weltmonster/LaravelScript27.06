...
class DeliveryMethodsController extends Controller
{
    ...
    public function showDeliveryMethodEditPage($id)
    {
        ...
        return view('backendV2.management.delivery_methods.edit', [
    ...
    {
        return view('backendV2.management.delivery_methods.add', [
            'managementPage' => true,
        ]);
    }
    ...
    public function showDeliveryMethodsPage(Request $request, $pageNumber = 0)
    {
        ...
        return view('backendV2.management.delivery_methods.list', [
