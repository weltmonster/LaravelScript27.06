...
class FAQsCategoriesController extends Controller
{
    ...
    public function showFAQCategoryEditPage($id, $lang = null)
    {
        ...
        return view('backendV2.management.faqs.categories.edit', [
    ...
    {
        return view('backendV2.management.faqs.categories.add', [
            'managementPage' => true,
        ]);
    }
    ...
    public function showFAQsCategoriesPage(Request $request, $pageNumber = 0)
    {
        ...
        return view('backendV2.management.faqs.categories.list', [
