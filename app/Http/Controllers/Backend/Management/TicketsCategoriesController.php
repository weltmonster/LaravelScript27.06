...
class TicketsCategoriesController extends Controller
{
    ...
    public function showTicketCategoryEditPage($id, $lang = null)
    {
        ...
        return view('backendV2.management.tickets.categories.edit', [
    ...
    {
        return view('backendV2.management.tickets.categories.add', [
            'managementPage' => true,
        ]);
    }
    ...
    public function showTicketsCategoriesPage(Request $request, $pageNumber = 0)
    {
        ...
        return view('backendV2.management.tickets.categories.list', [
