...
class ProductsCategoriesController extends Controller
{
    ...
    public function showProductCategoryEditPage($id, $lang = null)
    {
        ...
        return view('backendV2.management.products.categories.edit', [
    ...
    {
        return view('backendV2.management.products.categories.add', [
            'managementPage' => true,
        ]);
    }
    ...
    public function showProductsCategoriesPage(Request $request, $pageNumber = 0)
    {
        ...
        return view('backendV2.management.products.categories.list', [
