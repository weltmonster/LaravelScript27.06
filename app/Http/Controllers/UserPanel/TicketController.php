...
namespace App\Http\Controllers\UserPanel;
    ...
    class TicketController extends Controller
    {
        ...
        public function shownewTicketCreatePage(Request $request)
        {
            ...
            return view('frontend/userpanel.tickets.newcreate');
        }
        ...
        public function shownewTicketPage($id)
        {
            $ticket = UserTicket::where('user_id', Auth::user()->id)->where('id', $id)->get()->first();
            $ticketReplies = UserTicketReply::where('ticket_id', $id)->get()->all();
        ...
        public function shownewTicketsPage($pageNumber = 0)
        {
            $user_tickets = UserTicket::where('user_id', Auth::user()->id)->orderByDesc('updated_at')->paginate(10, ['*'], 'page', $pageNumber);
            ...
            return view('frontend/userpanel.tickets.newlist_tickets', [
                'user_tickets' => $user_tickets,
            ]);
        }
    }
